	...
	"netboot=echo Booting from net ...; " \
		...
		"findfdt="\
			"if test $fdt_file = undefined; then " \
				"if test $board_name = OPENREX && test $board_rev = MX6Q; then " \
					"setenv fdt_file imx6q-openrex-ldo.dtb; fi; " \
				"if test $board_name = OPENREX && test $board_rev = MX6DL; then " \
					"setenv fdt_file imx6dl-openrex-ldo.dtb; fi; " \
				"if test $fdt_file = undefined; then " \
